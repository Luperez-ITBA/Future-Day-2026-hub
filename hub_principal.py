...
with col_boton_intro:
    st.markdown('<a href="https://future-day-2026-intro-yym3jwktpbunjoytjix7xq.streamlit.app/" target="_blank" class="btn-nav">Introducción Teórica-Histórica</a>', unsafe_allow_html=True)
